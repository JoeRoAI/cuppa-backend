...
class EngagementController {
  ...
  async updateComment(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      // Update comment
      const updatedComment = await EngagementService.updateComment(commentId, userId, content);
  ...
  async getComments(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      // Get comments
      const comments = await EngagementService.getComments(targetId, targetType, {
        page,
        limit,
